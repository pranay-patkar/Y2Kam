...
const ctx = canvas.getContext('2d');const fileInput = document.getElementById('fileInput');
const openBtn = document.getElementById('openBtn');
const canvas = document.getElementById('canvas');
...
const themeOrangeBtn = document.getElementById('themeOrangeBtn');
const themeMintBtn = document.getElementById('themeMintBtn');
const themeButtons = { blue: themeBlueBtn, pink: themePinkBtn, orange: themeOrangeBtn, mint: themeMintBtn };
...
[grainEl, flashEl, saturEl, pixelEl, fadeEl, chromaEl, scanlinesEl, redBalanceEl, greenBalanceEl, blueBalanceEl].forEach(el => {
  el.addEventListener('input', () => { syncLabels(); render(); });
});
rgbResetBtn.addEventListener('click', () => {
  redBalanceEl.value = 0;
